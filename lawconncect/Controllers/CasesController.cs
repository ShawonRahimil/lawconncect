...
namespace lawconncect.Controllers
{
    public class CasesController : Controller
    {
        ...
        {
            return View(await _context.Sases.ToListAsync());
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var @case = await _context.Sases.FindAsync(id);
            if (@case == null)
            {
                return NotFound();
            }
        ...
        {
            return _context.Sases.Any(e => e.ID == id);
        }
    }
}
